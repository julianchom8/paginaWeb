												...
												<!--/sub-heard-part-->	
													<!--/forms-->
														<div class="forms-main">
															<h2 class="inner-tittle">Insertar SubTema </h2>
																<div class="graph-form">
																		<div class="form-body">
																			<form action = "insertar_subtema.php" method="post" enctype="multipart/form-data">Ingrese SubTema</label> <input type="text" name="subtitulo" class="form-control" placeholder="titulo"> </div> <div class="form-group"> <label >Descripcion</label> <input type="text" name="descripcion" class="form-control"  placeholder="descripcion"> </div> <div class="form-group"> <label>Ingrese Imagen</label> <input type="file" name="imagenes" >  </div>  <button type="submit" class="btn btn-default">Insertar</button> </form> 
																		</div>
